   ...
   <?php if (transaksi_cs($_POST) > 0) : ?>
      <div class="alert">
         ...
         <img src="<?=url('_assets/img/berhasil.png')?>" height="68" alt="alert sukses">
            ...
            <button onclick="window.location='http://localhost/fresh_laundry/riwayat_transaksi/riwayat.php'" class="btn-alert btn-success">Ok</button>
         </div>
      </div>
      <?php else :?>
      <div class="alert">
...
<head>
   ...
   <link rel="shortcut icon" href="<?=url('_assets/img/logo/logo_kuning_text.svg')?>" type="image/x-icon">
</head>
<body>
