							...
							<div class="container-paket">
								<div class="col-paket">
									<a href="<?=url('paket/pkt_ck/pkt_ck.php')?>" class="paket">
										<img src="<?=url('_assets/img/komplit.png')?>" alt="cuci komplit" width="160">
								...
								<div class="col-paket">
									<a href="<?=url('paket/pkt_dc/pkt_dc.php')?>" class="paket">
										<img src="<?=url('_assets/img/clean.png')?>" alt="dry clean" width="160">
								...
								<div class="col-paket">
									<a href="<?=url('paket/pkt_cs/pkt_cs.php')?>" class="paket">
										<img src="<?=url('_assets/img/satuan.png')?>" alt="cuci satuan" width="160">
